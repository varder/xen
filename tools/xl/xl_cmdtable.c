...
struct cmd_spec cmd_table[] = {
    ...
    { "vcamera-attach",
      &main_vcameraattach, 1, 1,
      "Create a new virtual camera device",
      " TBD\n"
    },
    { "vcamera-list",
      &main_vcameralist, 0, 0,
      "List virtual camera devices for a domain",
      "<Domain(s)>",
    },
    { "vcamera-detach",
      &main_vcameradetach, 0, 1,
      "Destroy a domain's virtual camera device",
      "<Domain> <DevId>",
    },
    { "uptime",
      &main_uptime, 0, 0,
